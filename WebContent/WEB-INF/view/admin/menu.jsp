<div class="leftpanel">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        <li class="active"><a href="adminIndex.htm"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                        
                        <li><a href="ManageUser.htm"><span class="pull-right badge"></span><i class="fa fa-envelope-o"></i> <span>Manage User</span></a></li>
