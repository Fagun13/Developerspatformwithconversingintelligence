...
<html lang="en">
 ...
 <jsp:include page="menu.jsp"></jsp:include>
        ...
        <script src="adminResources/js/flot/jquery.flot.min.js"></script>
        <script src="adminResources/js/flot/jquery.flot.resize.min.js"></script>
        <script src="adminResources/js/flot/jquery.flot.spline.min.js"></script>
        <script src="adminResources/js/jquery.sparkline.min.js"></script>
        <script src="adminResources/js/morris.min.js"></script>
        <script src="adminResources/js/raphael-2.1.0.min.js"></script>
        <script src="adminResources/js/bootstrap-wizard.min.js"></script>
