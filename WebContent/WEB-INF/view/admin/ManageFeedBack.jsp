                    ...
                    <div class="contentpanel">
                       ...
                       <div class="row">
                                            <div class="form-group">
												...
												<c:forEach  begin="1" end="${sessionScope.ratings}">
                            ...
                            <table id="basicTable" class="table table-striped table-bordered responsive">
                                ...
                                <tbody>
                                 <c:forEach items="${list}" var="list1">
                                    <tr>
                                        <td>${list1.feedbackId}</td>
                                        <td>${list1.feedbackRating}</td>
                                        <td>${list1.feedbackDescription}</td>
                                        <td>${list1.feedbackDate}</td>
                                        <td>${list1.feedbackTime}</td>
