                        ...
                        <div class="panel panel-primary-head">
                            ...
                            <table id="basicTable" class="table table-striped table-bordered responsive">
                                ...
                                <c:forEach items="${list}" var="list1">
                                    <tr>
                                        <td>${list1.registrationId}</td>
                                        <td>${list1.registrationFname}</td>
                                        <td>${list1.registrationLname}</td>
                                        <td>${list1.loginVO.username}</td>
                                        <td><a href='deleteUser.htm?id=${list1.registrationId}&loginId=${list1.loginVO.loginId}'>Delete</a></td>
                                    </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
